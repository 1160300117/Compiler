...
public class Token implements Cloneable {
	static List<String> id_list; 	// 标识符表
	String name; 					// 定义的种别码
	String value = null;			// 值
	String source; 					// 源代码
	...
	public Token(String name, String source) {
		...
		if (name.equals("int") || name.equals("unsigned") || name.equals("long") || name.equals("long_unsigned")) {
			...
			if (source.charAt(0) == '0') {
				if (source.length() == 1 || source.equals("0l") || source.equals("0L") || source.equals("0U")
						|| source.equals("0u") || source.equals("0LU") || source.equals("0Lu") || source.equals("0lU")
						|| source.equals("0lu")) {
					this.value = "0";
					return;
				}
